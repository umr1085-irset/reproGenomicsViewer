    ...
    try :
        ...
        for geneLine in geneFile.readlines():
            if geneLine[0] != '#':
                ...
                Synonyms = split[5]
                description = split[6]
                geneList.append(Gene(gene_id=GeneID, tax_id=tax_id, homolog_id=homologeneID, ensemble_id=ensembleID, symbol=Symbol, synonyms=Synonyms, description=description))
